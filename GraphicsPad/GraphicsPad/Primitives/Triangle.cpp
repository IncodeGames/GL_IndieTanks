...
Triangle::Triangle(GLuint vertexID)
{
	...
	triangle[0].position.y = 1.0f;
	triangle[0].position.z = 0.0f;

	triangle[1].position.x = -1.0f;
	triangle[1].position.y = -1.0f;
	triangle[1].position.z = 0.0f;

	triangle[2].position.x = 1.0f;
	triangle[2].position.y = -1.0f;
	triangle[2].position.z = 0.0f;
	...
	glBufferData(GL_ARRAY_BUFFER, shapeData3d.vertexBufferSize() , shapeData3d.vertices, GL_STATIC_DRAW);
